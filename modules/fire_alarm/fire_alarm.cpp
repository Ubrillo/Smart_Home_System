...
DigitalIn fireAlarmTestButton(p14);
...
void fireAlarmUpdate()
{
    ...
    //gasDetectorState = !gasSensorRead();  -- how it should be when mq2 is connected
    gasDetectorState = gasSensorRead();  //mq2 not connected on the  bread board
